...
# Например, user@gmail.com. Именно его необходимо указывать как
# ВАШ_EMAIL_ДЛЯ_ОТПРАВКИ_СООБЩЕНИЯ в исходном коде предыдущего пункта
EMAIL_HOST_USER = 'reklamaindigo@gmail.com'
